      ...
      {initialType.map((type, index) => {
        return (
          <button
            ...
            className="capitalize px-2 py-1 text-color-primary rounded-md link-blur-group shadow shadow-color-black font-medium bg-color-accent hover:bg-color-accent/50 text-sm sm:text-base"
          >
            {type}
          </button>
        );
