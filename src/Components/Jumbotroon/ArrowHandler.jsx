...
const ArrowHandler = ({ prevSlide, nextSlide }) => {
  return (
    <section className="flex justify-between absolute bottom-[50%] left-0 right-0 px-1 md:px-3 gap-6 transition-all duration-75 visible lg:invisible lg:group-hover:visible">
      <button
